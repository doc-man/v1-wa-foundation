'use strict';
angular.module('myApp').controller("timeInPsytxTherapistMasterCtrl", ['$scope', '$state', '$stateParams', '$timeout', 'timeInPsytxTherapistMasterService', '$filter',
    function($scope, $state, $stateParams, $timeout, timeInPsytxTherapistMasterService, $filter)
    {
        ...
        {
            timeInPsytxTherapistMasterService.timeInPsytx('getTimeInPsytx').getTimeInPsytx(function(data)
            {
        ...
        $scope.fnSaveTimeInPsytx = function(arData,prDataType)
        {
            ...
            timeInPsytxTherapistMasterService.timeInPsytx('saveTimeInPsytx').saveTimeInPsytx({id:arData.timeInPsytxID}, arData, function()
            {
...
angular.module('myApp').service("timeInPsytxTherapistMasterService", ['$resource',
    function($resource)
    {
        var factory = {};
        factory.timeInPsytx = function(queryType)
        {
            ...
            if (queryType == 'getTimeInPsytx') {
                hsRESTUri = apiResourceUrl + 'getTimeInPsytxForTherapist';
            } else if (queryType == 'saveTimeInPsytx') {
                hsRESTUri = apiResourceUrl + 'saveTimeInPsytxForTherapist/:id';
            }
